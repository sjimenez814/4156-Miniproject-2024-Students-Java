...
public class RouteController {
  ...
  *
  * @param courseCode     A {@code int} representing the course within the department.
  * @param count          An {@code int} representing the new number of enrolled students
  *                       for the course.
  *
  * @return               A {@code ResponseEntity} object containing an HTTP 200 response with a
  *                       success message if the update is successful, or an HTTP 404 response
  *                       with an error message if the course is not found. In case of an
  *                       exception, it returns a proper error response based on the exception
  *                       handling mechanism.
  */
   ...
   *
   * @param deptCode       A {@code String} representing the dept. code where the course is located.
   * @param courseCode     A {@code int} representing the course code whose location will update.
